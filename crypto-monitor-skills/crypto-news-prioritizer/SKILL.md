...
- **Иски US/EU регуляторов против непубличных частных компаний** с
  привлечённым капиталом <$50M и числом потерпевших <500, если ответчик не
  входит в TOP-50 индустрии (см. `references/aggregator-foreign-enforcement.md`).
  Низкий сигнал для банка РК: мошенничество локального масштаба не меняет
  ни регуляторную, ни клиентскую повестку.
