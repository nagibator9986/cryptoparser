...
- **Quality floor: статьи с `priority: low` НЕ включаются в сводку.**
  Прайоритайзер уже вынес вердикт «низкий сигнал» — показывать их читателю
  значит противоречить собственной оценке. Если после фильтра LOW в наборе
  ничего не осталось — сводка состоит только из шапки с пометкой
  «Сегодня не зафиксировано значимых событий…» и подвала. Тишина лучше шума.
